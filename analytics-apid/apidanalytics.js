...
ApidAnalytics.prototype.send = function(scopeId, data, cb) {
    ...
    request(opts, (err, res, body) => {
        ...
        if(res.statusCode == 500) {
          self.logger.error(body, 'Error flushing analytics records. Retrying...', 'analytics');  
          return cb(null, scopeId, data)
        } else if(res.statusCode == 400) {
          self.logger.error(body, 'Error flushing analytics records. Not retrying.', 'analytics');  
